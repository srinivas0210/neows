  ...
  return (
    <div className="app flex">
      <div className="app__header flex">
        ...
        <div className="app__myFav">
          <StarsSharpIcon  />
        </div>
        <MuiPickersUtilsProvider utils={DateFnsUtils}>
          <Grid container justify="space-around" className="app__searchDates flex">
            <KeyboardDatePicker
              margin="normal"
      ...
      <div className="app__listHeading">
            <h1>Hey {userName} , here are the asteroids</h1>
        </div>
